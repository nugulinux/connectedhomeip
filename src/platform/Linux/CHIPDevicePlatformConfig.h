...
#ifndef CHIP_DEVICE_CONFIG_ENABLE_DBUS
#define CHIP_DEVICE_CONFIG_ENABLE_DBUS 0
#endif
...
#if CHIP_DEVICE_CONFIG_ENABLE_DBUS || CHIP_DEVICE_CONFIG_ENABLE_CHIPOBLE || CHIP_DEVICE_CONFIG_ENABLE_THREAD || CHIP_DEVICE_CONFIG_ENABLE_WIFI
